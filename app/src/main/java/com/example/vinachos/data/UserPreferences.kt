package com.example.vinachos.data
...
class UserPreferences(context: Context) {
    ...
    // Función eliminar la lista de usuarios
    ...
    // Función para limpiar toda la sesión de usuario
    suspend fun clearUserSession() {
        dataStore.edit { preferences ->
            preferences.clear() // Elimina todas las claves en el DataStore
        }
    }
